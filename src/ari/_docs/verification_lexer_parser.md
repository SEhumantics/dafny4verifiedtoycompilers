...
The lexer and parser are generated using ANTLR 4. The generated Python code is in the `antlr\.antlr` directory (which was automatically generated by the VSCode extension for ANTLR 4). The lexer and parser are in the `AriLexer.py` and `AriParser.py` files, respectively.
