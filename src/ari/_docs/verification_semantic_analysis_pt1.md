# Verification of the Semantic Analysis phase - Part 1. Defining the AST and rewriting rules

## Table of Contents

- [Verification of the Semantic Analysis phase - Part 1. Defining the AST and rewriting rules](#verification-of-the-semantic-analysis-phase---part-1-defining-the-ast-and-rewriting-rules)
...
The `Expr` datatype is defined in Dafny as follows:
...
The `Stmt` datatype is defined in Dafny as follows:
